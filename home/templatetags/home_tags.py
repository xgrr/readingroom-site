...
def get_site_root(context):
    ...
    if hasattr(context["request"], "site"):
        ...
        return Page.objects.live()[0].get_children()[0]
...
@register.inclusion_tag("home/tags/blog_listing_homepage.html", takes_context=True)
...
@register.inclusion_tag("home/tags/event_listing_homepage.html", takes_context=True)
